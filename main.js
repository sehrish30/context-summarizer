...
//  the complete, permanent chat history. Every message ever sent is stored here. Used only for display in the UI and as input to splitForSummary.
const messages = [...initialMessages];

//  what actually gets sent to the AI. Starts the same as messages, but gets replaced with a compressed version (summary + recent messages) when the token limit is hit.
